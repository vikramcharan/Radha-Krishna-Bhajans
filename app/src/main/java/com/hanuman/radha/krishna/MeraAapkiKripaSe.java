...
public class MeraAapkiKripaSe extends BaseActivity implements MediaPlayer.OnPreparedListener {
...
//        animat();
        ...
        player = MediaPlayer.create(MeraAapkiKripaSe.this, R.raw.meraaapkikripase);
        seekBar.setMax(0);
