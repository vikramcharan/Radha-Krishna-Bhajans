...
public class MaiyaMoriMain extends BaseActivity implements MediaPlayer.OnPreparedListener {
...
//        animat();
        ...
        player = MediaPlayer.create(MaiyaMoriMain.this, R.raw.maiyamorimain);
        seekBar.setMax(0);
