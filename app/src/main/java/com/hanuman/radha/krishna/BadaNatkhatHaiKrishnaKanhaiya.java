...
public class BadaNatkhatHaiKrishnaKanhaiya extends BaseActivity implements MediaPlayer.OnPreparedListener {
...
//        animat();
        ...
        player = MediaPlayer.create(BadaNatkhatHaiKrishnaKanhaiya.this, R.raw.badanatkhathaikrishnakanhaiya);
        seekBar.setMax(0);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (item.getItemId() == R.id.action_about_hanuman) {
            Uri uri = Uri.parse("https://shriradhakrishna.com");
            Intent intent = new Intent(Intent.ACTION_VIEW, uri);
            startActivity(intent);
        }
