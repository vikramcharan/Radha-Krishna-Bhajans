...
public class ChotiChotiGaiya extends BaseActivity implements MediaPlayer.OnPreparedListener {
...
//        animat();
        ...
        player = MediaPlayer.create(ChotiChotiGaiya.this, R.raw.chotichotigaiya
        );
        seekBar.setMax(0);
