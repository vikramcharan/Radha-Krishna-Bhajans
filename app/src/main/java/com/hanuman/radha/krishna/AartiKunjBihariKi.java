...
public class AartiKunjBihariKi extends BaseActivity implements MediaPlayer.OnPreparedListener {
...
//        animat();
        ...
        player = MediaPlayer.create(AartiKunjBihariKi.this, R.raw.aartikunjbihariki);
        seekBar.setMax(0);
