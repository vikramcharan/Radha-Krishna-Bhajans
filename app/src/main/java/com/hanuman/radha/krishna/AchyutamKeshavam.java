...
public class AchyutamKeshavam extends BaseActivity implements MediaPlayer.OnPreparedListener {
...
//        animat();
        ...
        player = MediaPlayer.create(AchyutamKeshavam.this, R.raw.achyutamkeshavam);
        seekBar.setMax(0);
