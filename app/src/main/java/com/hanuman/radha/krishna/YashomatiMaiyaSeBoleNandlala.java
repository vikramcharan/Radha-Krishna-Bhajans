...
public class YashomatiMaiyaSeBoleNandlala extends BaseActivity implements MediaPlayer.OnPreparedListener {
...
//        animat();
        ...
        player = MediaPlayer.create(YashomatiMaiyaSeBoleNandlala.this, R.raw.yashomatimaiyasebolenandlala);
        seekBar.setMax(0);
