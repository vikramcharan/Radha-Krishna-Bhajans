...
public class HaiGopalMeroHai extends BaseActivity implements MediaPlayer.OnPreparedListener {
...
//        animat();
        ...
        player = MediaPlayer.create(HaiGopalMeroHai.this, R.raw.haigopalmerohai);
        seekBar.setMax(0);
